...
# Напишем метод, который будет принимать любое количество аргументов и возвращать их среднее геометрическое
#
# Для проверки метода написаны unit-тесты. Они находятся в папке 'tests/test_1.3.rb'
